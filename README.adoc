...
== Opening keeps manually

It is possible to interact with Bonded ECDSA keep factory manually using a smoke test from `keep-ecdsa/solidity/integration/smoke_test.js`. This test simulates a part of `tBTC` behavior but requires a manual setup.
