...
```
to the import section if it isn't there.
...
To see how much TBTC you have, add a custom token to your wallet with the address from:
```
tbtc/solidity/build/contracts/TBTCToken.json
```
and check the address at `networks.1101.address`. (mine is `0xF355D8f5Dca13CE5019675f5f2b2bD821b9A40b9`).
